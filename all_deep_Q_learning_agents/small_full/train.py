...
def back_and_forth_condition(self, self_action):
    if self.last_action == None:
        return False
    if self.last_action == 'UP' and self_action == 'DOWN':
        return True
    if self.last_action == 'DOWN' and self_action == 'UP':
        return True
    if self.last_action == 'LEFT' and self_action == 'RIGHT':
        return True
    if self.last_action == 'RIGHT' and self_action == 'LEFT':
        return True
