...
def setup_training(self):
    ...
    if not os.path.isfile("my-saved-model.pt"):     
        self.conv_w1 = init_weights((16, 6, 3, 3))
        self.conv_w2 = init_weights((32, 16, 3, 3))
        self.w_h1= init_weights((128, 64))
        self.w_h2 = init_weights((64, 32))
        self.w_o = init_weights((32, 6))
