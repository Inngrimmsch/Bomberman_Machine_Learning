...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]): 
    ...
    self.transitions.append(Transition(state_to_features(self, last_game_state), self.Q_table.squeeze(0), last_action, None, reward_from_events(last_game_state, self, events)))
    ...
    for t in range(last_game_state['step']):
        ...
        squared_loss_function = (true_reward+self.gamma*next_Q_Pred-Q_pred)**2
    ...
    squared_loss_function = (true_reward-Q_pred)**2
    self.optimizer.zero_grad()
    squared_loss_function.backward()
    self.optimizer.step()
