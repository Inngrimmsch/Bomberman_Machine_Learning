...
def setup_training(self):
    ...
    if not os.path.isfile("my-saved-model.pt"):     
        self.w_h1= init_weights((27, 100))
        self.w_h2 = init_weights((100, 150))
        self.w_h3 = init_weights((150, 100))
        self.w_o = init_weights((100, 6))
        self.a1 = init_alpha((100,))
        self.a2 = init_alpha((150,))
        self.a3 = init_alpha((100,))
...
def Moved_to_safety_condition(self, old_game_state: dict, new_game_state: dict) -> bool:
    ...
    if newfeat[0, 2, 1, 1] == 0 and oldfeat[0, 2, 1, 1] != 0:
        return True
    else:
        return False
