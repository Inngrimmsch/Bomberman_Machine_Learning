...
def setup_training(self):
    ...
    if not os.path.isfile("my-saved-model.pt"):     
        ...
        self.w_h1= init_weights((512, 256))
        self.w_h2 = init_weights((256, 128))
        self.w_o = init_weights((128, 6))
        self.a1 = init_alpha(64)
        self.a2 = init_alpha(128)
        self.a3 = init_alpha(256)
        self.a4 = init_alpha(128)
...
def end_of_round(self, last_game_state: dict, last_action: str, events: List[str]): 
    ...
    # Store the model
    self.model = {'wc1': self.conv_w1, 'wc2': self.conv_w2, 'w1': self.w_h1, 'w2': self.w_h2, 'wo': self.w_o, 'a1': self.a1, 'a2': self.a2, 'a3': self.a3, 'a4': self.a4}
