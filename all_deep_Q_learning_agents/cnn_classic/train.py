...
def setup_training(self):
    ...
    if not os.path.isfile("my-saved-model.pt"):     
        self.conv_w1 = init_weights((8, 3, 3, 3))
        self.conv_w2 = init_weights((16, 8, 3, 3))
        self.w_h1= init_weights((400, 400))
        self.w_h2 = init_weights((400, 200))
        self.w_o = init_weights((200, 6))
        self.a1 = init_alpha((400,))
        self.a2 = init_alpha((200,))
